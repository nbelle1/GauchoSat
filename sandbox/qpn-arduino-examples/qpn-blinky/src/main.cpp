...
void QF_onStartup(void) {
    // set Timer1 in CTC mode, 1/1024 prescaler, start the timer ticking...
...
void QV_onIdle(void) {   // called with interrupts DISABLED
    ...
    //Serial.println("idle!");
    SMCR = (0 << SM2) | (0 << SM1) | (0 << SM0) | (1 << SE); // idle mode, adjust to your project
